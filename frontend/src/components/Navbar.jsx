...
function Navbar() {
	...
	// safely open the login dialog (works with native <dialog>)
	const openLogin = () => setShowLogin(true);

	return (
		<>
			{/* OUTER NAVBAR WRAPPER = FULL WIDTH */}
			<div
				className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-in-out
				${sticky ? "shadow-md bg-base-200/90 z-50" : "bg-white"}`}
			>
				{/* INNER CONTAINER (NO OVERFLOW) */}
